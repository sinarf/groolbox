...
sudo apt-get install -y -qq gnome gawk maven2 groovy rar git git-gui openssh-server lm-sensors lame gpodder gparted gimp  chameleon-cursor-theme quicksynergy xsensors conduit screen subversion frozen-bubble wine hplip hplip-gui powertop compizconfig-settings-manager filezilla tasque  xubuntu-restricted-extras quicksynergy openjdk-7-jdk aspell-fr curl vim-gnome giggle bzr freeplane exuberant-ctags  mercurial remmina startupmanager   glipper libxml2-utils gradle gnome-do &&\
